                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    @if ($users->isEmpty())
                        <div class="text-center py-12">
                            <h3 class="text-lg font-medium text-gray-900">{{ __('No employees found') }}</h3>
                            <p class="mt-1 text-sm text-gray-500">
                                {{ __("You haven't added any employees yet.") }}<br>
                                {{ __('Click the button above to add your first employee.') }}
                            </p>
                        </div>
                    @else
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <div class="flex justify-end items-center space-x-2">
                                                        <a href="{{ route('admin.users.edit', $user) }}" class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
